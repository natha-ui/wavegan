...
This is a fork of Chris Donahue's **WaveGAN** (v2) that has been naively migrated to run on Tensorflow v2. This enables compatability with the latest NVidia libraries required to train using NVidia CUDA on RTX 3 series and later GPUs. (Tested on RTX3090 in a Windows WSL v2 instance).
